...
use routes::{
    ...
    create_task_list, daemon_shutdown_hook, delete_contact, delete_discovery_subscription,
    delete_kv_value, delete_machine, direct_connections, direct_message_send_config, direct_send,
    discover_groups, discover_groups_nearby, discovered_agent, discovered_agents,
    discovered_machine, discovered_machines, dm_diagnostics, enroll_device,
    ...
    list_tasks, load_causal_approval_queue, load_join_result_staging, load_named_groups_merged,
    load_predecessor_relay_outbox, load_treekem_member_key_packages, machine_for_agent_handler,
    machines_by_user_handler, mesh_join, mesh_quiesce, migrate_unsplit_home_suite_store_if_needed,
